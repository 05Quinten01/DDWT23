                ...
                <div class="col-md-8">
                    ...
                    <form action="<?= $form_action ?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputSeasons" name="Seasons"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="inputAbstract" name="Abstract" required><?php
                                    if (isset($series_info)){echo utf8_encode($series_info['abstract']);} ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control" id="inputId" name="Id"
                                       value="<?php if (isset($series_info)){echo $series_info['id'];} ?>"
                                >
                            </div>
                        </div>
